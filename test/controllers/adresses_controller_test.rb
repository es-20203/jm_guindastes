...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { city: @adress.city, client_id: @adress.client_id, driver_id: @adress.driver_id, neighborhood: @adress.neighborhood, number: @adress.number, street: @adress.street, zipcode: @adress.zipcode } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { city: @adress.city, client_id: @adress.client_id, driver_id: @adress.driver_id, neighborhood: @adress.neighborhood, number: @adress.number, street: @adress.street, zipcode: @adress.zipcode } }
