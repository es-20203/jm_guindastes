...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { cnh: @driver.cnh, cpf: @driver.cpf, name: @driver.name } }
    end
  ...
  test "should update driver" do
    patch driver_url(@driver), params: { driver: { cnh: @driver.cnh, cpf: @driver.cpf, name: @driver.name } }
